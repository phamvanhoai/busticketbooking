...
public class ScheduleDAO extends DBContext {
     ...
     *
     * @param originKeyword    chuỗi tìm kiếm origin (LIKE '%...%'), null hoặc rỗng = không filter
     * @param destKeyword      chuỗi tìm kiếm destination (LIKE '%...%'), null hoặc rỗng = không filter
