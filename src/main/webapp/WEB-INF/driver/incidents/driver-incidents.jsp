<%-- 
    Document   : driver-incidents
    Created on : Jul 23, 2025, 11:31:39 PM
...
<body class="bg-[#fff6f3] p-6">
    <div class="space-y-6">
        <div class="flex items-center justify-between mb-6">
            <h1 class="text-3xl font-bold text-orange-600">Incident Reports</h1>
            <a href="${pageContext.servletContext.contextPath}/driver/incidents?add">
