...
<html lang="en">
    <head>
        ...
        <title>FBus Staff Dashboard</title>
        <!-- Tailwind CSS -->
...
<!--                            <div class="flex items-center gap-3 cursor-pointer px-4 py-2 <%= request.getRequestURI().endsWith("staff-dashboard.jsp") ? "bg-[#F7F6F3] text-orange-600 font-semibold pl-6 rounded-r-xl rounded-l-none shadow -ml-4" : "text-white hover:bg-orange-300/20"%>">
                            ...
                            <div class="flex items-center gap-3 cursor-pointer px-4 py-2 <%= request.getRequestURI().endsWith("support-incidents.jsp") ? "bg-[#F7F6F3] text-orange-600 font-semibold pl-6 rounded-r-xl rounded-l-none shadow -ml-4" : "text-white hover:bg-orange-300/20"%>">
                                <a href="${pageContext.servletContext.contextPath}/staff/incidents">
                                    <span class="text-base"><i class="fas fa-table"></i></span>
                                    <span>Support Incidents</span>
                                </a>
                            </div>
                            <div class="flex items-center gap-3 cursor-pointer px-4 py-2 <%= request.getRequestURI().endsWith("reviews.jsp") ? "bg-[#F7F6F3] text-orange-600 font-semibold pl-6 rounded-r-xl rounded-l-none shadow -ml-4" : "text-white hover:bg-orange-300/20"%>">
                                <a href="${pageContext.servletContext.contextPath}/staff/reviews">
                                    <span class="text-base"><i class="fas fa-table"></i></span>
