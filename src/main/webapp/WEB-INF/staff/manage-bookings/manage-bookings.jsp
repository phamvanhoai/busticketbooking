        ...
        <div class="mt-12 px-4">
            ...
            <form id="filterForm" method="post" action="${pageContext.request.contextPath}/staff/manage-bookings" class="flex flex-wrap items-center gap-4 mb-6">
                <div class="flex-grow flex gap-2 min-w-[250px]">
                    <input type="text" name="q" value="${fn:escapeXml(q)}" placeholder="Search by Booking ID or Customer Name" class="w-full border border-orange-400 rounded-lg px-4 py-2 focus:outline-orange-500" />
                    ...
                    <tbody>
                        ...
                        <c:forEach var="booking" items="${bookings}">
                            <tr class="border-t hover:bg-gray-50 transition">
                                <td class="py-2 px-4">${booking.formattedTicketId}</td>
                                <td class="py-2 px-4">${booking.userName}</td>
                                <td class="py-2 px-4">${booking.routeName}</td>
                                <td class="py-2 px-4">
                                    <fmt:formatDate value="${booking.departureTime}" pattern="dd/MM/yyyy hh:mm a" />
                                </td>
                                <td class="py-2 px-4">${booking.seatCode}</td>
                                <td class="py-2 px-4">${booking.driverName}</td>
                                <td class="py-2 px-4">${booking.busType}</td>
                                <td class="py-2 px-4">
                                ...
                                <td class="py-2 px-4 text-center w-[100px]">
                                    <a href="${pageContext.request.contextPath}/staff/view-booking?id=${booking.ticketId}"
