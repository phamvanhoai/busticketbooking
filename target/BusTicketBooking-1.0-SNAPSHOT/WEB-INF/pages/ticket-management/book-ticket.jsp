            ...
            <div class="w-full lg:w-2/3 border rounded-xl bg-white">
                <div class="p-6">
                    ...
                    <table class="w-full mt-4">
                        <tbody>
                            <tr>
                                <td>
                                    <img src="<%= getServletContext().getContextPath()%>/assets/images/icons/seat_active.svg" alt="seat" class="w-8 h-8 mx-auto" />
                                    01
                                </td>
                                <td>
                                    <img src="<%= getServletContext().getContextPath()%>/assets/images/icons/seat_active.svg" alt="seat" class="w-8 h-8 mx-auto" />
                                ...
                                <td>
                                    <img src="<%= getServletContext().getContextPath()%>/assets/images/icons/seat_disabled.svg" alt="seat" class="w-8 h-8 mx-auto" />
                                    03
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <img src="<%= getServletContext().getContextPath()%>/assets/images/icons/seat_selecting.svg" alt="seat" class="w-8 h-8 mx-auto" />
                                    05
                                </td>
                                <td>
                                    <img src="<%= getServletContext().getContextPath()%>/assets/images/icons/seat_active.svg" alt="seat" class="w-8 h-8 mx-auto" />
                ...
                <div class="p-6">
                    <div class="flex items-center gap-2 mb-4">
                        ...
                        <img src="<%= getServletContext().getContextPath()%>/assets/images/icons/info_white.svg" alt="info" class="w-5 h-5 icon-orange" />
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 divide-x">
                        <div class="pr-6">
                            ...
                            <img src="<%= getServletContext().getContextPath()%>/assets/images/icons/arrow_down_select.svg" alt="dropdown" class="w-5 h-5 absolute right-4 top-1/2 transform -translate-y-1/2" />
